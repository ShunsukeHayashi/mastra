  ...
  return (
    <div className="container mx-auto px-4 py-6 sm:py-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h1 className="text-xl sm:text-2xl font-bold">契約書ダッシュボード</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
          ...
          <div className="mt-3 sm:mt-4 grid grid-cols-2 gap-2">
            ...
            <div className="bg-red-50 p-2 rounded">
              ...
              <div className="text-xs sm:text-sm text-gray-600">却下</div>
            </div>
            <div className="bg-blue-50 p-2 rounded">
              <div className="text-blue-600 font-semibold">{contracts.filter(c => c.status === 'finalized').length}</div>
              <div className="text-xs sm:text-sm text-gray-600">締結済み</div>
            </div>
          </div>
        </div>
        
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
          <h2 className="text-lg sm:text-xl font-semibold mb-2">最近のアクティビティ</h2>
          <ul className="space-y-2 sm:space-y-3">
            <li className="flex items-start">
              ...
              <div>
                <p className="text-xs sm:text-sm">秘密保持契約が承認されました</p>
            ...
            <li className="flex items-start">
              ...
              <div>
                <p className="text-xs sm:text-sm">新しい契約書がアップロードされました</p>
            ...
            <li className="flex items-start">
              ...
              <div>
                <p className="text-xs sm:text-sm">リーガルチェックでリスクが検出されました</p>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md">
          <h2 className="text-lg sm:text-xl font-semibold mb-2">承認待ち</h2>
              ...
              {contracts
                ...
                .map((contract, index) => (
                  <li key={contract.contractId} className="border-l-4 border-yellow-500 pl-3 py-1">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600">承認者: 担当者</p>
                    <p className="text-xs text-gray-500">期限: {new Date(new Date().getTime() + (index + 1) * 86400000).toLocaleDateString('ja-JP')}</p>
                  </li>
                ))}
            </ul>
          ) : (
            <p className="text-gray-500 text-xs sm:text-sm">現在、承認待ちの契約書はありません</p>
          )}
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6 sm:mb-8">
        <div className="p-3 sm:p-4 border-b border-gray-200 bg-gray-50">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            <h2 className="text-base sm:text-lg font-semibold">契約書一覧</h2>
