...
export const getNoteByIdTool = createTool({
  id: 'get-note-by-id',
  ...
  execute: async ({ context }) => {
    ...
    return {
      id: context.id,
      title: "Sample Note",
      content: "This is a sample note content. In a real implementation, this would be fetched from a database.",
      tags: ["sample", "mock"],
