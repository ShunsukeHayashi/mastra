...
export const postOptimizationAgent = new Agent({
  ...
  instructions: `
    ...
    【フェーズ1: トレンド分析】
    - getTrendingArticlesTool を使用して人気記事のメタデータを分析
    - analyzeTrendingThemesTool を使用して最新トレンドキーワードを特定
    - 競合記事のタイトル・タグ・サムネイル傾向を分析
    - クリック率の高いパターンを特定
    ...
    - トレンドを反映したタイトルの作成
    - クリック率を高めるタイトルの最終調整
    - 検索性を高めるタグの選定（トレンドキーワード優先）
    - 注目を集めるサムネイル画像の提案
    - 競合との差別化ポイントの強調

    【フェーズ4: 最終チェック】
    - SEO要素の最終確認（キーワード密度、メタタグ等）
    - 読みやすさと視覚的構成の確認
    - 全体の一貫性と流れの確認
    - トレンドとの整合性最終確認
    - 投稿準備完了の確認
    ...
    注意事項:
    - 常に最新のトレンドを反映したメタデータにすること
    - note.comのプラットフォーム特性を考慮すること
    - クリック率を高める要素を優先すること
    - 検索エンジンとユーザー体験の両方を最適化すること
    - 競合との差別化ポイントを強調すること
    - タイトル・タグ・サムネイルの一貫性を確保すること
    - 記事内容とメタデータの整合性を確保すること
  `,
  model: anthropic('claude-3-5-sonnet-20241022'),
  tools: { 
    searchNoteArticlesTool,
